...
curl -L -o crawl-300d-2M.vec.h5 "https://github.com/xingdi-eric-yuan/GATA-public/releases/download/data/crawl-300d-2M.vec.h5"
```
...
cd obs_gen.0.1 ; wget https://github.com/xingdi-eric-yuan/GATA-public/releases/download/data/obs_gen.0.1.zip ; unzip obs_gen.0.1.zip ; cd ..
# Train
...
```
# Download games
cd rl.0.2 ; wget https://github.com/xingdi-eric-yuan/GATA-public/releases/download/data/rl.0.2.zip ; unzip rl.0.2.zip ; cd ..
...
```
# Download data
cd ap.0.2 ; wget https://github.com/xingdi-eric-yuan/GATA-public/releases/download/data/ap.0.2.zip ; unzip ap.0.2.zip ; cd ..
# Train
...
```
# Download data
cd sp.0.2 ; wget https://github.com/xingdi-eric-yuan/GATA-public/releases/download/data/sp.0.2.zip ; unzip sp.0.2.zip ; cd ..
# Train
...
```
# Download data
cd dgi.0.2 ; wget https://github.com/xingdi-eric-yuan/GATA-public/releases/download/data/dgi.0.2.zip ; unzip dgi.0.2.zip ; cd ..
# Train
...
cd cmd_gen.0.2 ; wget https://github.com/xingdi-eric-yuan/GATA-public/releases/download/data/cmd_gen.0.2.zip ; unzip cmd_gen.0.2.zip ; cd ..
# Train
